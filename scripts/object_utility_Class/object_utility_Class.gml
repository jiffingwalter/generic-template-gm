...
function ObjectUtility(GMObject) constructor{
    ...
    ///@param {Array<ShaderUniformInput>} uniformInputs: Optional; An array of any uniform inputs of the format: {name, input}. Uniform input can be a callback for logic 
